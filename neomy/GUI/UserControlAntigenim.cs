...
namespace neomy.GUI
{
    public partial class UserControlAntigenim : UserControl
    {
        Antigen_Donors tblAntigen_Donors;

        public UserControlAntigenim()
        {
            InitializeComponent();
            tblAntigen_donate = new Antigen_DonorsDB();
            a = new Antigen_Donors();
            tblAntigen_Donors = new Antigen_Donors();
        }


        Antigen_DonorsDB tblAntigen_donate;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (CreateD())
            {
                ...
                if (!flagUpdate)
                {
                    ...
                    if (tblAntigen_donate.SearchId(a.Tz_donor) != null)
                    {
                        a = tblAntigen_donate.SearchId(a.Tz_donor);
                        if (a.Status == false)
                        {
                            a.Status = true;
                            tblAntigen_donate.UpdateRow(a);
