...
namespace neomy.Bll
{
    public class Antigen_Sick  //מחלקת יחיד של אנטיגנים לחולה
    {
        //תכונות המחלקה
        ...
        public Antigen_Sick(DataRow dr) : this()
        {
            this.dr = dr;
        ...
        {
            return new Antigen_SickDB().SearchId(this.tz_sick);
        }

        //פעולה שמביאה עצם מסוג חולה
        public Sick SickOfAntigen_Sick()
        {
